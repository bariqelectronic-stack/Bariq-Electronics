...
const relatedProducts: any[] = [];
  ...
  const productUrl = `https://bariq-electronics.vercel.app/products/${product.slug}`;
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <details className="w-full">
                <summary className="flex items-center justify-center gap-2 w-full py-3 border border-[#E5E5E5] rounded-[6px] text-sm font-semibold text-[#0A0A0A] hover:bg-[#F7F7F7] transition-colors cursor-pointer list-none">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-2.5 border border-[#E5E5E5] rounded-[6px] text-sm font-medium hover:bg-[#F7F7F7] transition-colors"
                  >
                    <MessageCircle className="w-4 h-4 text-[#16A34A]" />
                    WhatsApp
                  </a>
                  ...
                  <a
                    href={`https://t.me/share/url?url=${encodeURIComponent(productUrl)}&text=${encodeURIComponent(product.name)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-2.5 border border-[#E5E5E5] rounded-[6px] text-sm font-medium hover:bg-[#F7F7F7] transition-colors"
                  >
            ...
            {product.features && product.features.length > 0 && (
              <div className="bg-[#F7F7F7] border border-[#F0F0F0] rounded-[10px] p-4">
                ...
                <ul className="space-y-2">
                  {product.features.slice(0, 4).map((feat: any, i: number) => (
          ...
          <div className="p-6 space-y-8">
            ...
            {product.compatibility && product.compatibility.length > 0 && (
              <div>
                ...
                <ul className="space-y-1">
                  {product.compatibility.map((c: any, i: number) => (
            ...
            {product.whatsIncluded && product.whatsIncluded.length > 0 && (
              <div>
                ...
                <ul className="space-y-1">
                  {product.whatsIncluded.map((item: any, i: number) => (
                    <li key={i} className="text-sm text-[#6B6B6B] flex items-center gap-2">
